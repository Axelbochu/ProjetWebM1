...
interface ModalProps {
  setModalModifyBookIsOpen: React.Dispatch<React.SetStateAction<boolean>>;
  onClick?: () => void;
}

export const ModalModifyBook: React.FC<ModalProps> = ({ setModalModifyBookIsOpen, onClick }) => {
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black bg-opacity-20 z-0" onClick={() => setModalModifyBookIsOpen(false)} />
      <div className="fixed inset-0 flex items-center justify-center z-10">
        <div className="w-72 bg-white rounded-xl shadow-lg p-6 text-center">
          <div className="mb-4">
            <h5 className="text-lg font-semibold text-gray-800">Modification de livre</h5>
          </div>
          <div className="mb-6">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-around">
              ...
              <button
                ...
                onClick={() => setModalModifyBookIsOpen(false)}
              >
                Annuler
              </button>
            </div>
