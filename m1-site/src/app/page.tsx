...
function App() {
  ...
  return (
    <GlobalLayout>
      ...
      <h3 className='text-custom-dark font-elegant ml-10 text-3xl '>Nos Recomendations :</h3>
      <div className="flex flex-wrap gap-8 ml-10 mt-8">
        {/* Right side: Mieux Noté book */}
        <div className="absolute w-full  sm:w-1/2 xl:w-1/4 right-20 top-16 bg-red-200">
          ...
          <BookCard
            coverImage={books[1].coverImage} // You can dynamically pick the highest rated book
            title={books[1].title}
            author={books[1].author}
            rating={books[1].rating}
            date={books[1].date}
            hauteur="h-[70vh]"  // Larger size for the book
            largeur="w-full" // Full width for the right-side card
